...
ARCHAEOLOGY_COMPLETION = "完成次数：|cffffffff%d";
...
ARENA_MASTER_NO_SEASON_TEXT = "竞技场和评级战场的战斗只在PVP赛季中开放。第十一季的战斗将在第十季战斗结束后一周开放，准备好迎接即将到来的荣誉之战吧！";
...
BINDING_NAME_TARGETLASTHOSTILE = "选择上一个敌对目标";
BINDING_NAME_TARGETLASTTARGET = "选择上一个目标";
...
BINDING_NAME_TARGETPREVIOUSENEMY = "选择前一个敌人";
...
BINDING_NAME_TOGGLEMUSIC = "开启/关闭音乐";
...
BINDING_NAME_TOGGLESELFMUTE = "开启/关闭自我禁声";
BINDING_NAME_TOGGLESHEATH = "取出/收起武器";
BINDING_NAME_TOGGLESOCIAL = "打开/关闭社交界面";
BINDING_NAME_TOGGLESOUND = "开启/关闭声效";
...
BN_BLOCK_FAILED_TOO_MANY_RID = "你能够屏蔽的实名好友已达上限。";
...
BOSS_ALIVE = "可击杀";
BOSS_ALIVE_INELIGIBLE = "符合条件|cffff2020（不符合条件）|r";
BOSS_DEAD = "已击杀";
...
CONFIRM_TALENT_WIPE = "你确定要遗忘所有的天赋吗？";
...
CREATE_MACROS = "创建宏";
CREATE_NEW_COMPACT_UNIT_FRAME_PROFILE = "创建一个新资料";
CREATURE = "怪物";
...
CR_DODGE_TOOLTIP = "躲闪等级%d可使躲闪几率提高%.2f%%|n|cff888888（在效果递减之前）|r";
...
CR_PARRY_TOOLTIP = "招架等级%d可使招架几率提高%.2f%%|n|cff888888（在效果递减之前）|r";
CTRL_KEY = "CTRL键";
CTRL_KEY_TEXT = "CTRL";
CURRENCY = "货币";
...
CURRENCY_RECEIVED_THIS_WEEK = "本周目前收到%s：";
...
ENCOUNTER_JOURNAL_SECTION_FLAG9 = "毒药效果";
...
ERR_PARTY_ROLE_NOT_AVAILABLE = "%s不能胜任你队伍中的任何空缺位置";
...
GUILD_CHALLENGE_REWARD_XP = "每个完成的公会挑战都会奖励每日上限以外的公会经验。如果你的公会还未达到经验上限，这部分经验将会提高目前的公会每日经验上限。\n\n|cffffd200奖励：|r\n%d公会经验";
...
GUILD_NEW_RANK = "新会阶";
GUILD_NEXT_PERK_LEVEL = "下一项福利：|cffff2020%s级";
...
GUILD_REPUTATION_WARNING = "你会失去在%s公会中的公会声望";
GUILD_REPUTATION_WARNING_GENERIC = "你会失去在上一个公会中的公会声望";
...
INTERACT_ON_LEFT_CLICK_TEXT = "左键点击操作|TInterface\\OptionsFrame\\UI-OptionsFrame-NewFeatureIcon:0:0:0:-1|t";
...
ITEM_MOD_CRIT_RATING = "使你的爆击等级提高%d。";
...
ITEM_MOD_HASTE_RATING = "使你的急速等级提高%d。";
...
ITEM_MOD_HIT_RATING = "使你的命中等级提高%d。";
...
ITEM_MOD_MASTERY_RATING = "使你的精通等级提高%d。";
ITEM_MOD_MASTERY_RATING_SHORT = "精通等级";
...
ITEM_MOD_RESILIENCE_RATING = "使你的韧性等级提高%d。";
...
ITEM_REQ_ARENA_RATING_3V3_BG = "需要战场等级达到%d或者|n个人及战队竞技场等级|n在3v3/5v5中比赛达到%d";
ITEM_REQ_ARENA_RATING_5V5 = "需要5v5的个人竞技场等级和战队竞技场等级达到%d|n";
ITEM_REQ_ARENA_RATING_BG = "需要战场等级达到%d或者|n个人及战队竞技场等级达到%d";
...
LEVEL_UP_TALENTPOINT_LINK = "获得了新的|cffFF4E00|Htalentpane:|h[天赋点数]|h|r！";
LEVEL_UP_TALENTS_LINK = " |cffFF4E00|Htalentpane:|h[天赋]|h|r";
LEVEL_UP_TALENT_MAIN = "获得新的天赋点数";
...
LFM_TITLE = "招募队员";
LFR_QUEUE_GROUP_INELIGIBLE = "你的团队不能通过团队查找器加入任何随机团队副本。";
...
MANA_COLON = "法力值：";
MANA_COMBAT_REGEN_TOOLTIP = "战斗状态下每5秒恢复%d点法力值。";
MANA_COST = "%d法力值";
...
MELEE_ATTACK_POWER_SPELL_POWER_TOOLTIP = "使近战武器的每秒伤害提高%.1f。\n法术强度提高%d。";
...
NEWBIE_TOOLTIP_ENCOUNTER_JOURNAL = "查看《大地的裂变》中各个地下城及团队地下城首领的资料，包括他们的技能和收藏的宝物。";
...
NEW_COMPACT_UNIT_FRAME_PROFILE = "新资料";
...
NEXT_TALENT_LEVEL = "下一个天赋点数将在|cffffd200%d级|r解锁";
NO = "否";
NONE = "无";
NONEQUIPSLOT = "制造品";
NONE_CAPS = "无";
...
OPTIONS_MENU = "选项菜单";
OPTIONS_SHADERS = "遮罩";
OPTION_BN_WHISPER_MODE_INLINE = "实名悄悄话会显示在你的默认聊天标签页中。在聊天界面的玩家名字上单击右键可以将悄悄话移至一个新窗口中。";
OPTION_BN_WHISPER_MODE_POPOUT = "新的实名悄悄话会显示在新的标签页中。";
OPTION_BN_WHISPER_MODE_POPOUT_AND_INLINE = "新的实名悄悄话会同时显示在你的默认聊天标签页和新的标签页中。";
...
OPTION_CONVERSATION_MODE_POPOUT_AND_INLINE = "新的实名会同时显示在你的默认聊天标签页和新的标签页中。";
...
PET_LEVEL_UP_TALENTPOINT_LINK = "获得了新的|cffFF4E00|Hpettalentpane:|h[宠物天赋点]|h|r！";
PET_LEVEL_UP_TALENT_MAIN = "新宠物天赋点数";
...
PET_TYPE_DEMON = "恶魔";
PET_TYPE_PET = "宠物";
PET_UNSPENT_TALENT_POINTS = "你的宠物有|cffffd200 %s |r点未分配的天赋点数";
PET_WAIT = "停留";
PHONG_SHADING = "阴影平滑";
...
PLAYER_UNSPENT_TALENT_POINTS = "你有|cffffd200 %s |r点未分配的天赋点数";
PLAYER_V_PLAYER = "PvP";
...
PVP_ARENA_PARTY_ERROR = "|cff808080你必须与战队队友组队参赛。";
PVP_CONQUEST = "征服点数";
...
SPELL_FAILED_CUSTOM_ERROR_122 = "你必须先选择一个天赋专精。";
...
STAT4_NOSPELLPOWER_TOOLTIP = "法力值增加%d点\n法术爆击几率提高%.2f%%";
STATISTICS = "统计";
...
STAT_AVERAGE_ITEM_LEVEL_TOOLTIP = "你最强装备的平均等级。提高该数值能使你在使用地下城查找器时进入更困难的地下城。";
STAT_BLOCK = "格挡";
...
STAT_HEALTH_PET_TOOLTIP = "生命最大值。如果生命值为0，则该生物会死亡。";
STAT_HEALTH_TOOLTIP = "你的生命值上限。如果你的生命值为0的话，那你就会死亡。";
STAT_HIT_CHANCE = "命中几率";
STAT_HIT_MELEE_TOOLTIP = "命中等级%d（+%.2f%%命中率）";
STAT_HIT_NORMAL_ATTACKS = "普通攻击";
STAT_HIT_RANGED_TOOLTIP = "命中等级%d（+%.2f%%命中率）";
STAT_HIT_SPECIAL_ATTACKS = "特殊攻击";
STAT_HIT_SPELL_TOOLTIP = "命中等级%d（+%.2f%%命中率）";
STAT_MANA_TOOLTIP = "法力值上限。施放法术需要消耗法力值。";
STAT_MASTERY = "精通";
STAT_MASTERY_TOOLTIP = "精通等级%d（+%.2f精通）";
...
STAT_TEMPLATE = "%s状态";
STAT_TOOLTIP_BONUS_AP = "攻击强度提高%d\13";
...
TALENTS_CHOOSE_SPEC_SUBHEADER = "你会立即获得强大的奖励加成。";
...
TALENTS_UNAVAILABLE_TOOLTIP = "该功能将会在你获得一个天赋点数之后开启。";
...
TALENT_MICRO_BUTTON_TUTORIAL = "你获得了你的第一个天赋点！点此以选择你的天赋。";
...
TALENT_TREE_PREVIEW_TUTORIAL = "分配好天赋点数之后，点击学习按钮以确认。你可以随时造访你的职业训练师以重置你所选择的天赋。";
TALL = "长";
TAMEABLE = "可驯服";
...
TRIAL_RESTRICTED = "你需要转换你的账号才能开启这项功能。";
...
TUTORIAL52 = "恭喜！你获得了你的第一个小宠物。这个小家伙将会陪你走遍艾泽拉斯和其它世界的每个角落。|n|n你可以点击|cffffd200法术书按钮|r中的|cffffd200小伙伴|r标签来查看你所有的小宠物。";
TUTORIAL53 = "恭喜，你已经学会了如何召唤你的第一头坐骑。这头强大的坐骑会载着你走遍艾泽拉斯以及更遥远的地方。|n|n你可以点击|cffffd200法术书|r中的|cffffd200坐骑|r标签来查看自己所有的坐骑。你可以将最喜欢的坐骑的图标拖放到你的技能栏中，便于快速使用。";
...
TUTORIAL5_MAGE = "要与你的敌人战斗，点击|cffffd200动作条|r上的|cffffd200火球术|r。";
...
TUTORIAL61_WARRIOR = "你学会了一种新的|cffffd200作战姿态|r。你在不同的战斗姿态下能够使用不同的技能，并获得不同的奖励效果。防御姿态造成的伤害比战斗姿态要低，但会让你更难以被杀死，这在扮演坦克角色时尤其有用。";
...
VIDEO_OPTIONS_TEXTURE_DETAIL_FAIR = "高材质分辨率，低地貌细节，低玩家角色材质分辨率。";
VIDEO_OPTIONS_TEXTURE_DETAIL_HIGH = "高材质分辨率，高地貌细节，高玩家角色材质分辨率。";
VIDEO_OPTIONS_TEXTURE_DETAIL_LOW = "低材质分辨率，低地貌细节，低玩家角色材质分辨率。";
VIDEO_OPTIONS_TEXTURE_DETAIL_MEDIUM = "高材质分辨率，高地貌细节，低玩家角色材质分辨率。";
...
WATCH_FRAME_WIDTH_TEXT = "更宽的任务目标追踪器";
